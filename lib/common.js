...
common.runCf = function(options, callback) {
  execFile('cf', options, function(error, stdout, stderr) {
    if (error) {
      if (stderr) {
...
common.runCfWithSync = function(options) {
  try {
    return execFileSync('cf', options);
  } catch(e) {
    var errorMsg;
    if (e.stderr.length) {
